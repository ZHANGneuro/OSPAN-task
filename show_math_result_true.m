...
function show_math_result_true(wPtr,w,h,math_result_true,color_marker_T,color_marker_F) 
Screen('TextFont',wPtr, 'Arial');
Screen('TextStyle',wPtr, 1);
Screen('TextSize',wPtr, 80);
[nx, ny, bbox] = DrawFormattedText(wPtr, math_result_true, 'center', 3*h/10, 0);
Screen('TextFont',wPtr, 'Arial');
Screen('TextStyle',wPtr, 1);
